...
public class Panel {
	...
	public void draw(int mouseX, int mouseY, float partialTicks) {
		...
		font.drawString(module.getName(), (int)x+7, (int)y+7, 0x40ffffff);
		...
		if(extended) {
			...
			for(Setting s : module.settings) {
				...
				if(s instanceof KeyBindSetting) {
					...
					RenderUtils.glColor(255, 255, 255, 255);
					font.drawString(setting.name+": "+setting.getMode(), (int)(100+x+7), (int)(YY+y+7), 0x40ffffff);
				}
					...
					RenderUtils.glColor(255, 255, 255, 255);
					font.drawString(s.name, (int)(100+x+7), (int)(YY+y+7), 0x40ffffff);
				}
				i++;
				YY+=font.getHeight()+11;
			}
