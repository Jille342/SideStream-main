...
public class HUD2 extends Module {
    ...
    BooleanSetting background;
    BooleanSetting info;
    BooleanSetting OUTLINE;
    BooleanSetting inversion;
    ...
    public void init() {
        super.init();
        this.colormode = new ModeSetting("Color Mode ", "Pulsing", new String[] {"Default", "Rainbow", "Pulsing", "Category", "Test"});
        ...
        this.inversion = new BooleanSetting("Outline", true);
        addSetting(info,OUTLINE,background,colormode, inversion);
    }
